...
const BUSINESS_GROUPS = {{
    ...
    'Vedanta Group': ['VEDL','HINDZINC','VAML','VEDPOWER','VISL','VOGL','STLTECH'],
    ...
    'PSU Companies': ['SBIN','BANKBARODA','PNB','CANBK','UNIONBANK','IOB','CENTRALBK','UCOBANK','INDIANB','MAHABANK','BANKINDIA','PSB','COALINDIA','ONGC','IOC','BPCL','HINDPETRO','GAIL','NTPC','POWERGRID','NHPC','SJVN','IREDA','PFC','RECLTD','IRFC','IRCTC','RVNL','NBCC','BEL','HAL','BDL','BHEL','BEML','CONCOR','NMDC','SAIL','HINDCOPPER','MOIL','NFL','RCF','FACT','HUDCO','NLCINDIA','OIL','MRPL','CHENNPETRO','MIDHANI','GRSE','COCHINSHIP','MAZDOCK','ITI','MTNL','NATIONALUM','HINDZINC','ENGINERSIN','RITES','RAILTEL','KIOCL','BLIL','BALMLAWRIE','SCI','MMTC','STCINDIA','LICI','GICRE','NIACL','IRCON'],
}};
